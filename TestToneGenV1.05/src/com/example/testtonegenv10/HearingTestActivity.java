...
public class HearingTestActivity extends android.support.v4.app.FragmentActivity implements OnClickListener {
    ...
    static int newvalue = TRUE;//static variable only exists in one copy and belongs to classic
	...
	public void updatePlot() {
        ...
        else if (rightEarButton.isChecked()) {
  	    LineAndPointFormatter series2Format = new LineAndPointFormatter();
  		series2Format.setPointLabelFormatter(new PointLabelFormatter());
  		series2Format.configure(getApplicationContext(),
  				R.xml.line_point_formatter_with_plf2);
  		...
  		switch(v.getId()) {
  		  ...
  		  case R.id.nextButton: {
  			 ...
  			 for (int counter = 1; counter < SERIES_LEN; counter += 1) {
  				  ...
  				  yVals[counter] = (int)(Math.random() * 10);
  		  ...
  		  case R.id.leftEarButton: {
  				try {
  					if(leftEarButton.isChecked())
  						...
  						frequencygen.playTone(0.0f, 0.0f); 
